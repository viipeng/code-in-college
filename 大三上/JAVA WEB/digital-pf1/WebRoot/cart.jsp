	...
	<div class="main mt10">
		...
		<!--购物车开始-->
			...
			<s:iterator id="cartItem" value="#session.CART">
				...
				<div class="car_c fl">
					<p class="sl fl"><s:property value="value.pi.id"/> </p>
					<p class="sl fl"><s:property value="value.pi.name"/></p>
					<p class="sl fl">￥<s:property value="value.pi.price"/></p>
					<p class="sl fl">
					...
					<p class="sl fl">￥<s:property value="value.quantity*value.pi.price"/></p>
					<p class="sl fl"><a href="deleteSelectedOrders?productInfoId=${value.pi.id }">
