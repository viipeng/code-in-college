				...
				<div class="login_d fl">
					<form name="loginform" action="loginAction" method="post">
						<table width="350" border="0" cellpadding="0" cellspacing="0">
						  ...
						  <tr>
						    <td height="50" colspan="2" align="center" valign="middle"><input type="radio" name="radiobutton" value="radiobutton" />
						      	请保存我这次的登陆信息</td>
						    </tr>
						  <tr>
						    <td height="50" colspan="2" align="center" valign="middle"><!-- input type="image" src="images/d017.jpg"/-->
						    <input type="submit" height="50" value="登录"></td>
						    <!--   onclick="window.location.href='login.action'" onClick="location='login.action'"  -->
						  </tr>
						  <tr>
						    <td height="35" colspan="2" align="center" valign="middle">注册邮件找回密码</td>
						  </tr>
						</table>
					</form>
				</div>
