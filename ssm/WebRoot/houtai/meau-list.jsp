...
<div class="page-container">
	<div class="text-c"> 
		<form action="${pageContext.request.contextPath }/meauInfo/selectByMid" method="post">
			<input type="text" class="input-text" style="width:250px" placeholder="输入菜单号" id="" name="mid1">
				<button type="submit" class="btn btn-success radius" id="" name="">
					<i class="Hui-iconfont">&#xe665;</i> 搜菜单</button>
		</form>
	</div>
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
		<a href="javascript:;" onclick="delManyData()" class="btn btn-danger radius">
			<i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> 
		<a href="../meauInfo/jumpToAdd"  class="btn btn-primary radius">
			<i class="Hui-iconfont">&#xe600;</i> 添加菜单</a>
		<a href="${pageContext.request.contextPath }/meauInfo/selectAll" class="btn btn-success radius">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<c:forEach items="${meauList }" var="meau">
			<tr class="text-c">
				<td><input type="checkbox" value="${meau.mid }" name="check"></td>
				<td>${meau.mid}</td>
				<td>${meau.mname}</td>
				<c:choose>
					<c:when test="${sessionScope.rid==null }">
				...
				<td class="td-manage"> 
					<a title="修改" href="${pageContext.request.contextPath }/meauInfo/jumpToUpdate?mid=${meau.mid}" style="text-decoration:none">
						<i class="Hui-iconfont">&#xe6df;</i></a> 
					<a title="删除" href="${pageContext.request.contextPath }/meauInfo/deleteMeau?mid=${meau.mid}" class="ml-5" style="text-decoration:none">
						<i class="Hui-iconfont">&#xe6e2;</i></a>
				</td>
			</tr>
		    </c:forEach>
...
/* 			alert(cks[i].value); */
	...
	/* alert(str); */
	location.href="${pageContext.request.contextPath }/meauInfo/deleteManyMeau?str="+str;
}
</script>  
</body>
</html>