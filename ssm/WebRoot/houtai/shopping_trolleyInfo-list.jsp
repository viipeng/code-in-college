...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 
	<span class="c-gray en">&gt;</span> 购物车管理 
...
<div class="page-container">
	<div class="text-c"> 
		<form action="${pageContext.request.contextPath }/shopping_trolleyInfo/selectBySid" method="post">
			<input type="text" class="input-text" style="width:250px" placeholder="输入购物车号" id="" name="sid1">
				<button type="submit" class="btn btn-success radius" id="" name="">
					<i class="Hui-iconfont">&#xe665;</i> 搜购物车</button>
		</form>
	</div>
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
		<a href="javascript:;" onclick="delManyData()" class="btn btn-danger radius">
			<i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> 
		<a href="../shopping_trolleyInfo/jumpToAdd"  class="btn btn-primary radius">
			<i class="Hui-iconfont">&#xe600;</i> 添加购物车</a>
		<a href="${pageContext.request.contextPath }/shopping_trolleyInfo/selectAll" class="btn btn-success radius">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				<td><input type="checkbox" value="${sti.sid }" name="check"></td>
				<td>${sti.sid}</td>
				<td>${sti.total}</td>
				<td>${sti.foodSum}</td>
				<td>${sti.shipping_fee}</td>
				<td>${sti.uid}</td>
				<td>${sti.rid}</td>
				<td class="td-manage"> 
					<a title="修改" href="${pageContext.request.contextPath }/shopping_trolleyInfo/jumpToUpdate?sid=${sti.sid}" style="text-decoration:none">
						<i class="Hui-iconfont">&#xe6df;</i></a> 
					<a title="删除" href="${pageContext.request.contextPath }/shopping_trolleyInfo/deleteSTInfo?sid=${sti.sid}" class="ml-5" style="text-decoration:none">
						<i class="Hui-iconfont">&#xe6e2;</i></a>
				</td>
			</tr>
		    </c:forEach>
...
/* 			alert(cks[i].value); */
	...
	/* alert(str); */
	location.href="${pageContext.request.contextPath }/shopping_trolleyInfo/deleteManySTInfo?str="+str;
}
</script>  
</body>
</html>