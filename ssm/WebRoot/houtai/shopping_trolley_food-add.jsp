...
<meta name="description" content="添加购物车菜品">
</head>
<body>
<article class="page-container"> 
	<form action="${pageContext.request.contextPath }/shopping_trolley_food/addShopping_trolley_food" method="post" class="form form-horizontal" onsubmit="return check()"><!-- id="form-member-add" --> 
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="sid" name="sid">
			</div>
		</div>
		<div class="row cl">
