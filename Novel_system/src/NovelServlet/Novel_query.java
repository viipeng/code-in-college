...
public class Novel_query extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if(Novel.next()){
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("/Novel/Novel_query1.jsp");
                dispatcher .forward(request, response);
				
			}
			else{
	             JOptionPane.showMessageDialog(null, "²éÑ¯Ê§°Ü", "³ö´íÀ²", JOptionPane.ERROR_MESSAGE);
				 RequestDispatcher dispatcher = request.getRequestDispatcher("/Novel/Novel_query.jsp");
	             dispatcher .forward(request, response);
			}
