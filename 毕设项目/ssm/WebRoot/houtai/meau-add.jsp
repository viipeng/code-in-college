...
<article class="page-container"> 
	<form action="${pageContext.request.contextPath }/meauInfo/addMeau" method="post" class="form form-horizontal" onsubmit="return check()"> <!-- id="form-member-add" -->
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>菜单名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="mname" name="mname">
			</div>
		</div>
		<c:choose>
		...
		<div class="row cl">
			...
			<c:when test="${sessionScope.rid!=null }">
				<input type="hidden" value="${sessionScope.rid }" id="rid" name="rid">
			</c:when>
		</c:choose>
		<div class="row cl">
