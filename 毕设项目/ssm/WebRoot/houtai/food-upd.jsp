...
<article class="page-container"> 
	<form action="${pageContext.request.contextPath }/foodInfo/updateFood" method="post" class="form form-horizontal" onsubmit="return check()"><!-- id="form-member-add" --> 
		<c:forEach items="${fiList }" var="fi">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>FID：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${fi.fid }" placeholder="" id="fid" name="fid" readonly="true" >
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>菜名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${fi.fname }" placeholder="" id="fname" name="fname">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>图片地址：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${fi.fphoto }" placeholder="" id="fphoto" name="fphoto">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>价格：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${fi.fprice }" placeholder="" id="fprice" name="fprice">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>描述：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${fi.fdescription }" placeholder="" id="fdescription" name="fdescription">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<c:choose>
					<c:when test="${sessionScope.rid==null }">
						<input type="text" class="input-text" value="${fi.fsales_volume }" placeholder="" id="fsales_volume" name="fsales_volume">
					</c:when>
					<c:when test="${sessionScope.rid!=null }">
						<input type="text" class="input-text" value="${fi.fsales_volume }" placeholder="" id="fsales_volume" name="fsales_volume" readonly="true">
					</c:when>
				</c:choose>
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<c:choose>
					<c:when test="${sessionScope.rid==null }">
						<input type="text" class="input-text" value="${fi.great }" placeholder="" id="great" name="great">
					</c:when>
					<c:when test="${sessionScope.rid!=null }">
						<input type="text" class="input-text" value="${fi.great }" placeholder="" id="great" name="great" readonly="true">
					</c:when>
				</c:choose>
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${fi.mid }" placeholder="" id="mid" name="mid">
			</div>
		</div>
		<div class="row cl">
...
<script type="text/javascript">
function check(){
	if(isNaN(document.getElementById('fprice').value)){
		alert('价格只能输入数字');
		return false;
	}
	else if(isNaN(document.getElementById('fsales_volume').value)){
		alert('月售数只能输入数字');
        return false;
    }
	else if(isNaN(document.getElementById('great').value)){
		alert('推荐数只能输入数字');
		return false;
	}
	else if(isNaN(document.getElementById('mid').value)){
		alert('MID只能输入数字');
        return false;
    }
	else{
